              ...
              .get(
                ...
                function (t) {
                  e._settings.loadInContent &&
                    ("" !== e._settings.sourceSelector && (t = n.default(t).find(e._settings.sourceSelector).html()),
      ...
      return (
        ...
        (e._jQueryInterface = function (t) {
          ...
          a || ((a = new e(n.default(this), i)), n.default(this).data(c, "string" == typeof t ? a : t)),
            "string" == typeof t && /collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/.test(t)
              ? a[t]()
      ...
      return (
        ...
        (t._init = function () {
          ...
          t.hasClass(L) || t.hasClass(D)
            ? (n.default(k).not(this._config.target).hide(), n.default(this._config.target).css("display", "block"))
            : n.default(k).hide(),
            this._fixHeight(),
            this._fixScrollHeight(),
        ...
        (t._fixScrollHeight = function () {
          ...
          if (e.hasClass(R)) {
            ...
            if (0 === o && 0 === i)
              t.css({ bottom: a.footer, top: a.header }), r.css("height", a.window - (a.header + a.footer));
            else if (i <= a.footer)
              if (!1 === s) {
                var d = a.header - o;
      ...
      return (
        ...
        (t.createTab = function (e, t, a, i) {
          ...
          this._config.allowDuplicates &&
            ((l += "-" + Math.floor(1e3 * Math.random())), (s += "-" + Math.floor(1e3 * Math.random())));
          var r =
        ...
        (t.openTabSidebar = function (e, t) {
          ...
          if ("#" !== o && "" !== o && void 0 !== o) {
            ...
            ((!this._config.allowDuplicates && 0 === n.default("#" + s).length) || this._config.allowDuplicates) &&
    ...
    Me = (function () {
      ...
      return (
        (t.fixLayoutHeight = function (e) {
          ...
          var t = n.default("body"),
            a = 0;
          (t.hasClass("control-sidebar-slide-open") || t.hasClass("control-sidebar-open") || "control_sidebar" === e) &&
          ...
          !1 !== l &&
            ...
            this._isFooterFixed() &&
              s.css(this._config.panelAutoHeightMode, parseFloat(s.css(this._config.panelAutoHeightMode)) + i.footer)),
        ...
        (t._init = function () {
          ...
          this.fixLayoutHeight(),
            !0 === this._config.loginRegisterAutoHeight
              ...
              : this._config.loginRegisterAutoHeight === parseInt(this._config.loginRegisterAutoHeight, 10) &&
